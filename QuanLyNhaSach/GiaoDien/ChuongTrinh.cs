    ...
    public partial class ChuongTrinh : Form
    {
        ...
        public void load()
        {
            ...
            if (Madn.StartsWith("NV"))
            {
                ...
                cHUCNANGADIMToolStripMenuItem.Visible = false;
            }
            else
            {
        ...
        private void LapPTT_Click(object sender, EventArgs e)
        {
            
        }

        private void BaoCaoTon_Click(object sender, EventArgs e)
        {
           frmBaoCaoTonKho bctk = new frmBaoCaoTonKho();
              bctk.ShowDialog();
        }

        private void BaoCaoNo_Click(object sender, EventArgs e)
        {
            frmBaoCaoNo bct = new frmBaoCaoNo();
            bct.ShowDialog();
        }
    }
}
