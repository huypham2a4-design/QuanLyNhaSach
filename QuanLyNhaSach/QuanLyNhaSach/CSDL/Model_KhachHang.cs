...
namespace QuanLyNhaSach.CSDL
{
    public class Model_KhachHang
    {
        ...
        public int KT_KhoaChinh(string pMa)
        {
            ...
            {
                conn.open_connect();
                string str = "select count(*) from khachhang where makhachhang ='" + pMa + "'";
        ...
        public int capNhatKH(Model.KhachHang KH)
        {
            ...
            {
                conn.open_connect();
                string str = "update KHACHHANG set tenkhachhang = N'" + KH.Tenkh + "', gioitinh = N'" + KH.Gioitinh + "', Diachi = N'" + KH.Diachi + "', sodienthoai = '" + KH.Sdt + "', email = '" + KH.Email + "' where makhachhang = '" + KH.Makh + "' ";
                SqlCommand cmd = new SqlCommand(str, conn.get_connect());
        ...
        public int xoaKH(Model.KhachHang KH)
        {
            ...
            {
                conn.open_connect();
                string str = "delete from KHACHHANG where makhachhang = '" + KH.Makh + "' ";
                SqlCommand cmd = new SqlCommand(str, conn.get_connect());
